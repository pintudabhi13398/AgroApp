...
function setActiveMenulink() {
    ...
    $('#sidenav ul li ul li:has(a[id="' + window.controllerName + '"])').addClass('active');
    $('#sidenav ul li:has(a[id="' + window.controllerName + '"])').addClass('active');
    $('#sidenav ul li ul:has(a[id="' + window.controllerName + '"])').addClass('displayBlock');
}
